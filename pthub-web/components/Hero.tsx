...
export default function Hero({ totalEvents, totalOrgs, lastVerified }: Props) {
  return (
    <section className="max-w-[1400px] mx-auto px-8 pt-10 pb-6 max-md:px-4 max-md:pt-5 max-md:pb-2">
      <h1 className="serif font-black leading-[1.1] tracking-tight" style={{ fontSize: 'clamp(26px, 4vw, 48px)' }}>
        흩어진 일정,<br className="max-md:hidden" /> <em className="not-italic font-normal" style={{ color: 'var(--accent)' }}>검증된</em> 정보로.
      </h1>
      <p className="mt-3 text-[15px] text-ink-soft max-w-[560px] max-md:text-[13px] max-md:mt-2">
